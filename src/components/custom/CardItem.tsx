  ...
  return (
    <Card>
      ...
      <CardFooter className="flex justify-between items-center">
        <p className="font-raleway font-[500] text-lg md:text-md w-[60%] truncate">Hamburguer</p>
        <p className="font-sans font-semibold text-lg md:text-sm text-end">R$ 455,99</p>
      </CardFooter>
    </Card>
  )
}
